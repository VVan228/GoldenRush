...
public class TransportDataServiceImpl implements TransportDataService{
    ...
    private static TransportType transportType00;
    private static TransportType transportType10;
    private static TransportType transportType20;
    ...
    public TransportDataServiceImpl() {
        ...
        val21.setParamId(transportParam21);


        val22.setId(22L);
        val22.setName("Бензин");
        val22.setParamId(transportParam21);


        val221.setId(221L);
        val221.setName("5,4");
        val221.setParamId(transportParam22);


        val222.setId(222L);
        val222.setName("6");
        val222.setParamId(transportParam22);


        val223.setId(223L);
        val223.setName("3");
        val223.setParamId(transportParam22);


        val224.setId(224L);
        val224.setName("8");
        val224.setParamId(transportParam22);


        val01.setId(01L);
        val01.setName("28");
        val01.setParamId(transportParam0);


        val02.setId(02L);
        val02.setName("32");
        val02.setParamId(transportParam0);


        val03.setId(03L);
        val03.setName("35");
        val03.setParamId(transportParam0);


        val04.setId(04L);
        val04.setName("45");
        val04.setParamId(transportParam0);


        val05.setId(05L);
        val05.setName("70");
        val05.setParamId(transportParam0);


        val1.setId(1L);
        val1.setName("100");
        val1.setParamId(transportParam1);

        val11.setId(11L);
        val11.setName("16");
        val11.setParamId(transportParam1);


        val12.setId(12L);
        val12.setName("160");
        val12.setParamId(transportParam1);

        val13.setId(13L);
        val13.setName("25");
        val13.setParamId(transportParam1);

        val14.setId(14L);
        val14.setName("35");
        val14.setParamId(transportParam1);

        val15.setId(15L);
        val15.setName("50");
        val15.setParamId(transportParam1);

        val16.setId(16L);
        val16.setName("60");
        val16.setParamId(transportParam1);

        val17.setId(17L);
        val17.setName("70");
        val17.setParamId(transportParam1);

        val201.setId(201L);
        val201.setName("Погрузчик_Телескопический");
        val201.setParamId(transportParam20);


        val202.setId(202L);
        val202.setName("Погрузчик_Вилочный");
        val202.setParamId(transportParam20);

        val203.setId(203L);
        val203.setName("Погрузчик_Ричтрак_контейнерный");
        val203.setParamId(transportParam20);

        val204.setId(204L);
        val204.setName("Погрузчик_с_боковым_поворотом");
        val204.setParamId(transportParam20);

        val205.setId(205L);
        val205.setName("Погрузчик_Фронтальный");
        val205.setParamId(transportParam20);
